          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="space-y-6 animate-fadeInUp">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
                Driven AI & Data Science undergraduate with expertise in machine learning, 
                deep learning, and data visualization. Transforming data into actionable insights 
          ...
          <div className="flex-shrink-0 animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            <div className="relative group">
              ...
              <img 
                src={profilePhoto}
                alt="MP Yuvashree"
                className="relative w-80 h-80 lg:w-96 lg:h-96 object-cover rounded-full border-4 border-primary/20 shadow-card"
              />
            </div>
          </div>
        </div>
